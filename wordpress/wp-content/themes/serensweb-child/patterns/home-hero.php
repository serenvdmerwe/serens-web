...
<section class="hero section--dark" id="hero" data-screen-label="Hero">
  ...
  <div class="wrap hero__inner">
    <div class="hero__copy reveal">
      ...
      <p class="hero__sub">I design and build fast, modern, conversion-focused websites: custom WordPress themes, AI-powered workflows, and installable, mobile-first sites. Independent, end to end, shipped with care.</p>
      <div class="hero__cta">
        ...
        <a href="#work" class="btn btn--ghost">View recent projects</a>
      </div>
    </div>
