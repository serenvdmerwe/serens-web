...
/**
 * Title: Home - Process
 * Slug: serensweb-child/home-process
 * Categories: serensweb-child
 * Description: Four-step process band (Discover, Design, Build, Launch and support).
 */
?>
<!-- wp:html -->
<section class="section section--dark2" id="process" data-screen-label="Process">
  <div class="wrap">
    <div class="section-head reveal">
      <h2 class="h2">A clear path, every time.</h2>
