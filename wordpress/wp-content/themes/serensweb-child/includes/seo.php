...
add_action( 'parse_request', static function ( $wp ) {
	...
	$lines = [
		...
		'- This site runs as a zero-plugin WordPress block theme; everything on it is hand-built.',
		...
		'- [Playground](' . $home . 'playground/): fifteen interactive experiments: live maps, browser games, honest calculators, installable apps, and explainers.',
